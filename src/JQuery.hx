...
extern class JQuery implements ArrayAccess<Dom> {	
	...
	**/
	public function trigger(eventType:String, extraParameters:Array<Dynamic>):JQuery;

	/**
		Execute all handlers attached to an element for an event.
	**/
	public function triggerHandler(eventType:String, extraParameters:Array<Dynamic>):JQuery;
...
extern class JQueryEvent {
	...
	**/
	...
	@:native('$.event')
#end
extern class JQueryEventS {
	/**
		Enables you to create custom jQuery events
	**/
		public static var special:Dynamic;
}
